...
abis.PropertyRegistry = [
  ...
  },
  {
    ...
    "name": "PropertyRegistryInitialized",
    "type": "event"
  },
  {
    "anonymous": false,
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "indexed": false,
        "internalType": "enum PropertyRegistry.PropertyStatus",
        "name": "oldStatus",
        "type": "uint8"
      },
      {
  ...
  },
  {
    ...
    "name": "getPropertyStatusExtended",
    "outputs": [
      {
        "internalType": "enum PropertyRegistry.PropertyStatus",
        "name": "status",
...
abis.RealEstateSystem = [
  ...
  },
  {
    ...
    "name": "RealEstateSystemInitialized",
    "type": "event"
  },
  {
    "anonymous": false,
  ...
  {
    "inputs": [],
    "name": "tokenHolderQuery",
    "outputs": [
      {
        "internalType": "contract TokenHolderQuery",
        "name": "",
        "type": "address"
      }
    ],
...
abis.RealEstateToken = [
  ...
  {
    "inputs": [],
    "name": "PROPERTY_STATUS_CHECKER_ROLE",
    "outputs": [
      {
        "internalType": "bytes32",
        "name": "",
  ...
  },
  {
    ...
    "name": "notifyPropertyStatusChange",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
...
abis.RedemptionManager = [
  ...
  },
  {
    "inputs": [
      ...
      {
        "internalType": "enum RedemptionManager.RedemptionStatus",
        "name": "currentStatus",
        "type": "uint8"
      }
    ],
  ...
  },
  {
    ...
    "name": "RedemptionManagerInitialized",
    "type": "event"
  },
  {
    "anonymous": false,
...
abis.RentDistributor = [
  ...
  },
  {
    ...
    "name": "DistributionUnclaimedMarked",
    "type": "event"
  },
  {
    "anonymous": false,
  ...
  },
  {
    ...
    "name": "RentDistributorInitialized",
    "type": "event"
  },
  {
    "anonymous": false,
  ...
  },
  {
    ...
    "name": "getDistributionSnapshotId",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
  ...
  },
  {
    ...
    "name": "liquidateUnclaimedStablecoin",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
  ...
  },
  {
    "inputs": [
      {
        "internalType": "address",
        "name": "_clearanceMultisig",
        "type": "address"
      }
    ],
    "name": "setClearanceMultisig",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
...
abis.RoleManager = [
  ...
  },
  {
    ...
    "outputs": [
      ...
      {
        "internalType": "bool",
        "name": "propertyManagerRole",
        "type": "bool"
      },
      {
        "internalType": "bool",
        "name": "feeCollectorRole",
        "type": "bool"
      }
    ],
    "stateMutability": "view",
...
// TokenHolderQuery ABI
abis.TokenHolderQuery = [
  {
    "anonymous": false,
    "inputs": [
      {
