...
router.get('/',
  ...
  ControllerFactory.getHandler(RoleController, 'getRoles')
);
...
router.get('/:roleId',
  AuthMiddleware.validateApiKey,
  ValidatorMiddleware.validateAddress('contractAddress'),
  ControllerFactory.getHandler(RoleController, 'getRole')
);
...
router.get('/members/:role',
  AuthMiddleware.validateApiKey,
  ValidatorMiddleware.validateAddress('contractAddress'),
  ControllerFactory.getHandler(RoleController, 'getRoleMembers')
);
